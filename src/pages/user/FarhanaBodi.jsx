...
/* ═══════════════════════════════════
   MAIN PAGE
═══════════════════════════════════ */
export default function FarhanaBodi() {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `https://fatography-backend.vercel.app/api/celebrity-shoot/get/farhana-bodi`,
        );
  ...
  return (
    <>
      <SEO
        title="Farhana Bodi Photoshoot Dubai | Fatography"
        description="Stunning celebrity photoshoot of Farhana Bodi in Dubai by Fatography. Premium portrait photography. View gallery today!"
      />
      <Header />
