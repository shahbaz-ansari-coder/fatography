...
/* ═══════════════════════════════════
   MAIN PAGE
═══════════════════════════════════ */
export default function FaisalKapadia() {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `https://fatography-backend.vercel.app/api/celebrity-shoot/get/faisal-kapadia`,
        );
  ...
  const coverSrc = images[2] || thumbnails[2] || "";
  const videoPoster = thumbnails[0] || images[0] || "";

  return (
    <>
      <SEO
        title="Faisal Kapadia Photoshoot Dubai | Fatography"
        description="Stunning celebrity photoshoot of Faisal Kapadia in Dubai by Fatography. Premium portrait photography. View gallery today!"
      />
      <Header />
