...
/* ═══════════════════════════════════
   MAIN PAGE
═══════════════════════════════════ */
export default function HasnainLehriShoot() {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `https://fatography-backend.vercel.app/api/celebrity-shoot/get/hasnain-lehri`,
        );
  ...
  return (
    <>
      <SEO
        title="Hasnain Lehri Photoshoot Dubai | Fatography"
        description="Stunning celebrity photoshoot of Hasnain Lehri in Dubai by Fatography. Premium portrait photography. View gallery today!"
      />
      <Header />
